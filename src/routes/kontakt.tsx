...
export const Route = createFileRoute("/kontakt")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Ring 070 — 000 00 00 eller skriv till hej@tinasstad.se. Vi svarar samma dag, mån–fre 07:00–17:00." },
      { property: "og:title", content: "Kontakt — Tinas Städ" },
      { property: "og:description", content: "Hör av dig — vi svarar samma dag." },
...
function Contact() {
  ...
  return (
    <PageShell>
      <PageHeader
        eyebrow="Kontakt"
        title={<>Hör av dig — vi <em className="italic font-light text-primary">svarar samma dag</em>.</>}
        ...
        <div className="grid md:grid-cols-12 gap-12">
          <div className="md:col-span-5 space-y-10">
            <div>
              ...
              <a href="tel:+46700000000" className="display-md hover:text-primary transition">070 — 000 00 00</a>
              <p className="text-sm text-ink-soft mt-2">Mån–fre 07:00–17:00. Lämna meddelande utanför kontorstid.</p>
            </div>
            <div>
              <div className="eyebrow mb-3">E-post</div>
              <a href="mailto:hej@tinasstad.se" className="display-md hover:text-primary transition">hej@tinasstad.se</a>
              <p className="text-sm text-ink-soft mt-2">Skicka gärna en bild på utrymmet du vill ha städat — det hjälper oss att ge pris direkt.</p>
            </div>
            <div>
              <div className="eyebrow mb-3">Besöksadress</div>
              <p className="text-lg">Sturegatan 12<br />597 30 Åtvidaberg</p>
              <p className="text-sm text-ink-soft mt-2">Ingång från gården. Besök efter överenskommelse.</p>
            </div>
            <div>
              <div className="eyebrow mb-3">Områden vi städar i</div>
              <p className="text-ink-soft">Åtvidaberg · Falerum · Grebo · Björsäter · Yxnerum · Hannäs · Rimforsa · delar av Linköping</p>
            </div>
          </div>
            ...
            <div className="bg-paper rounded-2xl p-8 md:p-10 border border-line">
              ...
              {sent ? (
                <div className="py-12 text-center">
                  <div className="display-md">Tack. Vi hör av oss inom dagen.</div>
                  <p className="text-ink-soft mt-3 text-sm">Brådskar det — ring oss direkt på 070 — 000 00 00.</p>
                </div>
              ) : (
                <form
                ...
                >
                  ...
                  <button className="btn-primary self-start mt-2">Skicka meddelande →</button>
                </form>
              )}
            </div>
          </div>

...
export const Route = createFileRoute("/om-oss")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Tinas Städ är en familjeägd städfirma i Åtvidaberg. Vi tror på samma städare, samma dag, år efter år." },
      { property: "og:title", content: "Om Tinas Städ" },
      { property: "og:description", content: "Lokal städfirma i Åtvidaberg sedan 2013." },
...
function About() {
  return (
    <PageShell>
      <PageHeader
        eyebrow="Om oss"
        title={<>En städfirma. <em className="italic font-light text-primary">Åtvidaberg.</em> Sedan 2013.</>}
        ...
        <div className="grid md:grid-cols-12 gap-10 mt-10">
          <div className="md:col-span-7">
            <div className="relative aspect-[4/3] overflow-hidden rounded-md">
              <img src={town} alt="Åtvidaberg" loading="lazy" className="absolute inset-0 w-full h-full object-cover" />
            </div>
          </div>
          <div className="md:col-span-5">
            <div className="relative aspect-[4/5] overflow-hidden rounded-md">
              <img src={detailTowels} alt="Linne" loading="lazy" className="absolute inset-0 w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container-page mt-28 grid md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-7 space-y-8 text-ink-soft text-lg leading-relaxed">
          <p>
            När Tina startade firman hade hon jobbat åtta år som städledare på ett stort företag i
            Linköping. Det fungerade, men kunderna såg sällan samma städare två gånger. Det blev
            opersonligt. Folk fick byta nyckeluttagare var tredje månad.
          </p>
          <p>
            Tanken bakom Tinas Städ var enkel: en kund, en städare, så länge båda vill. De flesta av
            våra kunder från 2013 är fortfarande kvar. Det är det mått på kvalitet som vi tror mest på.
          </p>
          <p>
            Vi tar inte fler kunder än vi hinner med. När kalendern är full skriver vi upp dig på en
            väntelista — vi har sällan plats direkt, men oftast inom sex till åtta veckor.
          </p>
        </div>
      </section>
      ...
      <section className="container-page mt-28">
        ...
        <div className="grid md:grid-cols-3 gap-10 hairline pt-12">
          {[
            ["Långsamt är bättre.", "Ett städ tar den tid det tar. Vi bygger in marginal i schemat så att städaren hinner göra det ordentligt — inte tre minuter för fort."],
            ["Lokala kunder, lokala anställda.", "Alla i teamet bor i Åtvidaberg eller Falerum. Alla får kollektivavtal, försäkring och tjänstepension från dag ett."],
            ["Lagom är gott.", "Vi vill inte bli stora. Vi vill att Tinas Städ ska finnas kvar om femton år och fortfarande städa hos samma familjer."],
          ].map(([h, b]) => (
            <div key={h}>
